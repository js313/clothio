...
function NewClothForm(props) {
    ...
    return (
        ...
        >
            <Box component="form" sx={{ position: 'absolute', top: '10%', left: '36.5%', width: '24%', bgcolor: 'background.paper', borderRadius: 1, p: 3, pt: 2, pb: 2, display: 'flex', flexDirection: 'column' }} onSubmit={submitHandler}>
