...
function ConfirmDelete(props) {
    ...
    return (
        ...
        >
            <Box sx={{ position: 'absolute', top: '30%', left: 0, right: 0, ml: 'auto', mr: 'auto', maxWidth: 300, bgcolor: '#202124', borderRadius: 1, p: 3, pt: 2, pb: 2, display: 'flex', flexDirection: 'column' }}>
                <Typography color='darkgray' component='h1' variant='h6' sx={{ m: 1, mb: 3 }}>This action cannot be undone, are you sure?</Typography>
                <Button onClick={deleteHandler} sx={{ mb: 1, pt: 1, pb: 1, color: 'red' }}>Delete</Button>
